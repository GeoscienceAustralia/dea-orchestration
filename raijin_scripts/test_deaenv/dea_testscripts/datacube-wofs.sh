...
datacube-wofs submit --app-config "$WORKDIR"/wofs_configfiles/wofs_albers.yaml -P u46 -q normal -C "$CONFIGFILE" -vvv --year "$YEAR" --tag "$YEAR" --no-qsub
datacube-wofs submit --app-config "$WORKDIR"/wofs_configfiles/wofs_albers.yaml -P u46 -q normal -C "$CONFIGFILE" -vvv --year "$YEAR" --tag "$YEAR" --dry-run
datacube-wofs submit --app-config "$WORKDIR"/wofs_configfiles/wofs_albers.yaml -P u46 -q normal -C "$CONFIGFILE" -vvv --year "$YEAR" --tag "$YEAR"
