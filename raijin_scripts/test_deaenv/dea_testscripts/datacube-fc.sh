...
datacube-fc submit --app-config "$WORKDIR"/fc_configfiles/ls8_fc_albers.yaml -M santosh.mohan@ga.gov.au -m ae -P u46 -q normal -C "$CONFIGFILE" -vvv --year "$YEAR" --tag "$YEAR" --no-qsub
